...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """
        Answer the question using ONLY the following context and history. If you don't know the answer just say that you don't know. DON'T make anything up.
...
if file:
    ...
    paint_history()
    add_memory_message(st.session_state["history_message"], "I'll remember it")
